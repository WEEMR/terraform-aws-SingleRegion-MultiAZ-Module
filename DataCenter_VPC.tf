...
resource "aws_subnet" "Private_Subnet_2" {
  ...
  availability_zone = data.aws_availability_zones.AZs_US_East_1.names[1]
  tags = {
    Name       = "${var.username}_Terraform_SDAWN_Virginia_Private_Subnet_2"
    Owner      = var.username
    Enviroment = "Terraform Testing"
...
// Virginia Private Subnet 2 Association 

resource "aws_route_table_association" "virginia_private2_RT_association" {
